...
logical :: dopblh = .true.
logical :: donodrag = .false.
logical :: pblhfluxmin=.false.    ! use level with minimum buoyancy flux
logical :: pblhthvgrad=.true.    ! use height with max dthv gradient (may lie betweenlevels)
...
integer :: dolwhomo=7
logical :: doradnoqc = .false.
logical :: doradnoqi = .false.
logical:: dosfchomo = .false.
logical:: dosfchomoqvonly = .false.
